...
if (length(gaps_user[grepl("Unzufrieden", gaps_user) | grepl("Differenz", gaps_user)]) > 0) {
  ...
  gaps <- "Aktuell keine Konflikte und Schieflagen"
}
...
{#Gap
  ...
  Qlist_Teil2a[1, ] <- c(QInputlist_Teil2a[1, c(1,2)], c(gaps), c(NA, NA, NA, NA))[1:7]
  Qlist_Teil2a[2, ] <- c(QInputlist_Teil2a[2, c(1,2)], c(gaps), c(NA, NA, NA, NA))[1:7]
}
...
{#Gap
  ...
  Qlist_Teil2a[5, ] <- c(QInputlist_Teil2a[5, c(1,2)], c(gaps), c(NA, NA, NA, NA))[1:7]
  Qlist_Teil2a[6, ] <- c(QInputlist_Teil2a[6, c(1,2)], c(gaps), c(NA, NA, NA, NA))[1:7]
}
...
{#Gap
  ...
  Qlist_Teil2a[9, ] <- c(QInputlist_Teil2a[9, c(1,2)], c(gaps), c(NA, NA, NA, NA))[1:7]
  Qlist_Teil2a[10, ] <- c(QInputlist_Teil2a[10, c(1,2)], c(gaps), c(NA, NA, NA, NA))[1:7]
}
